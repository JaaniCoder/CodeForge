...
const ProjectCard = ({project, index}) => {
  return ( <motion.div initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}} transition={{duration:.5, delay:index*0.1}} key={index} className='w-full cursor-pointer md:w-[450px] h-[375px] bg-secondary rounded-md p-4 flex flex-col items-center justify-center gap-4'>
    ...
    <div className='flex items-center justify-start gap-3 w-full'>
      ...
      {/* Collection */}
      <motion.div className='cursor-pointer ml-auto' whileTap={{scale : .9}}>
